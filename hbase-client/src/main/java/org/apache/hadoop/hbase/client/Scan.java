...
public class Scan extends Query {
   ...
   * cells in the row exceeded max chunk size on the server. Typically partial results will be
   ...
   */
  public void setAllowPartialResults(final boolean allowPartialResults) {
